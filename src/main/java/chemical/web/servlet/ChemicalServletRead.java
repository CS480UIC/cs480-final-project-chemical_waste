...
public class ChemicalServletRead extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			chemical = chemicalDao.findByID(request.getParameter("username"));
		...
		if(chemical.getID()!=null){
			...
			request.getRequestDispatcher("/jsps/entity1/chemical_read_output.jsp").forward(request, response);
		}
	}
}
